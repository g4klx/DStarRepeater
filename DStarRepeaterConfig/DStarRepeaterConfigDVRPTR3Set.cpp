...
BEGIN_EVENT_TABLE(CDStarRepeaterConfigDVRPTR3Set, wxDialog)
	EVT_CHOICE(CHOICE_TYPE, CDStarRepeaterConfigDVRPTR3Set::onConnectionType)
END_EVENT_TABLE()


CDStarRepeaterConfigDVRPTR3Set::CDStarRepeaterConfigDVRPTR3Set(wxWindow* parent, int id, CONNECTION_TYPE connectionType, const wxString& usbPort, const wxString& address, unsigned int port, bool txInvert, unsigned int modLevel, unsigned int txDelay) :
wxDialog(parent, id, wxString(_("DV-RPTR V3 Settings"))),
...
CDStarRepeaterConfigDVRPTR3Set::~CDStarRepeaterConfigDVRPTR3Set()
{
}

bool CDStarRepeaterConfigDVRPTR3Set::Validate()
{
...
CONNECTION_TYPE CDStarRepeaterConfigDVRPTR3Set::getConnectionType() const
{
...
wxString CDStarRepeaterConfigDVRPTR3Set::getUSBPort() const
{
...
wxString CDStarRepeaterConfigDVRPTR3Set::getAddress() const
{
	return m_address->GetValue();
}

unsigned int CDStarRepeaterConfigDVRPTR3Set::getPort() const
{
	unsigned long n;
...
bool CDStarRepeaterConfigDVRPTR3Set::getTXInvert() const
{
...
unsigned int CDStarRepeaterConfigDVRPTR3Set::getModLevel() const
{
	return (unsigned int)m_modLevel->GetValue();
}

unsigned int CDStarRepeaterConfigDVRPTR3Set::getTXDelay() const
{
	return (unsigned int)m_txDelay->GetValue();
}

void CDStarRepeaterConfigDVRPTR3Set::onConnectionType(wxCommandEvent &event)
{
